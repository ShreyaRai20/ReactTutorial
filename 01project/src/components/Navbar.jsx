...
const projects = [
  { name: 'Password Generator', description: 'Get a better understanding of your traffic', href: '/password-generator', icon: ChartPieIcon },
  { name: 'Context Page', description: 'Speak directly to your customers', href: 'context-page', icon: CursorArrowRaysIcon },
    ...
    <header className="bg-white dark:bg-gray-900">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <NavLink to="/" className={({isActive})=> `ext-sm/6 font-semibold ${isActive ? "text-orange-800":"text-white"} dark:text-white1`}>
            Home
          </NavLink>
          <a href="#" className="text-sm/6 font-semibold text-gray-900 dark:text-white">
            Marketplace
          </a>
          <NavLink to="/contact" className={({isActive})=> `ext-sm/6 font-semibold ${isActive ? "text-orange-800":"text-white"} dark:text-white1`}>
            Contact
          </NavLink>
        </PopoverGroup>
